...
[KiboAbilityOf(KiboTypeId.MasterBeaver, true)]
public sealed class KiboMasterBeaverStrikeCard() : KiboCard(1, CardType.Attack, TargetType.RandomEnemy)
{
    ...
    [
        ...
        new RepeatVar(2),
        ElementMark(2, SealElementType.Water),
    ];
