...
[KiboAbilityOf(KiboTypeId.Flamoo)]
public sealed class KiboFireSparkCard() : KiboCard(1, CardType.Skill, TargetType.RandomEnemy)
{
    ...
    {
        DynamicVars["Burn"].UpgradeValueBy(2);
    }
}
