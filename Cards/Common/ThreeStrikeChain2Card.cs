...
public sealed class ThreeStrikeChain2Card() : StarbornCard(
...
)
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        var canonical = ModelDb.GetById<CardModel>(ModelDb.GetId(typeof(ThreeStrikeChain3Card)));
        var phase3 = combatState.CreateCard(canonical, Owner);
        if (IsUpgraded)
            CardCmd.Upgrade(phase3);
        await CardPileCmd.AddGeneratedCardToCombat(phase3, PileType.Hand, Owner);
    }
